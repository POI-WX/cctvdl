...
describe('humanizeError', () => {
  ...
  it('does not misread a segment index as an HTTP 4xx error', () => {
    // "segment 404" must map to decrypt, not the access (4xx) message.
  ...
  it('prioritises specific rules (no-stream over generic 4xx)', () => {
    // contains neither; sanity that order is stable for a timeout+network combo
